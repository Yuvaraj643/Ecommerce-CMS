...
const Footer = () => {
  return (
    <footer className="flex flex-col w-full h-fit bg-[#374151] text-[#e5e7eb] px-14 py-14">
        ...
        <div className="flex flex-row w-[65%] justify-end gap-16 text-nowrap">
          ...
          <div className="flex flex-col gap-2">
            ...
            <form className="flex items-center">
              ...
              <button type="submit" className="bg-[#7e22ce] text-[#ffffff] font-semibold py-3 px-6 rounded-r-lg transition-colors duration-300">Subscribe</button>
            </form>
          </div>
        </div>
      </div>
